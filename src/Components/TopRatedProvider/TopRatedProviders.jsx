  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2 bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-500 bg-clip-text text-transparent">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-4 mb-10">
        <div className="card bg-base-100 shadow-md p-4 flex-1">
          <div className="font-bold mb-1  bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">
            Find Your Exchange
          </div>
      ...
      {/* Features */}
      <div>
        <h3 className="text-xl font-bold text-center my-6 bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-500 bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="card bg-base-100 shadow-md">
            ...
            <div className="card-body">
              <h4 className="font-bold text-lg text-teal-500">
                Affordable Learning
              </h4>
